 ...
 * шаблон для подключения кастомной формы поиска вместо стандартной
 * *( у woo свой поиск по товарам, к этой форме не относится)
 * выводится <?php get_search_form();?>
 */
...
<form class="search-form" role="search" method="get" action="<?php echo esc_url( home_url( '/' ) ); ?>" >
		...
		<input type="search" placeholder="Искать..." autocomplete="off" value="<?php echo get_search_query(); ?>" name="s" />
		<button type="reset" class="search-form__reset"><span>&times;</span></button>
		<button type="submit">
